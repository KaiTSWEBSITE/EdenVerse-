...
const reputationGuide = [
  ...
  { label: "Báo lỗi game hợp lệ", points: "+8" },
  { label: "Bấm tải game", points: "+2" }
];
...
export function ProfileOverview({
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardContent className="grid gap-5 p-6 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {reputationGuide.map((item) => (
                <div key={item.label} className="flex items-center justify-between rounded-lg border border-white/8 bg-black/18 px-3 py-2 text-sm">
