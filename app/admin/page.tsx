...
export default async function AdminPage() {
  ...
  const [heroIntro, metrics, supportSettings] = await Promise.all([
    getHeroIntro(),
    getDashboardMetrics(),
    getTranslatorSupportSettings()
  ]);
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      />
      <AdminPanel heroIntro={heroIntro} metrics={metrics} supportSettings={supportSettings} />
    </section>
  );
}
