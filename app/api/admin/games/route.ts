...
const gameDraftSchema = z.object({
  ...
  coverAspectRatio: z.enum(["aspect-[4/5]", "aspect-square", "aspect-video"]).default("aspect-[4/5]"),
...
const gameFieldLabels: Record<string, string> = {
  ...
  coverAspectRatio: "Tỷ lệ khung ảnh",
  coverZoom: "Zoom cover",
  coverPositionX: "Vị trí cover (X)",
...
function getGameFormPayload(formData: FormData) {
  return {
    ...
    coverAspectRatio: getText(formData, "coverAspectRatio") || "aspect-[4/5]",
